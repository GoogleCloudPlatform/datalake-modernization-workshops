...
databaseNm=sys.argv[4]
user_name=sys.argv[5]

# Output directory declaration
outputGCSURI="gs://"+sourceBucketName+"/cell-tower-anomaly-detection/01-datasets/"+user_name+"/output_data/kpis_by_cell_tower"
...
curatedTelcoPerformanceDataDF = spark.sql(""" select * from telco_performance_augmented """)
...
query = f"""
CREATE OR REPLACE EXTERNAL TABLE """+bqDatasetName+"""."""+user_name+"""_kpis_by_cell_tower OPTIONS (
