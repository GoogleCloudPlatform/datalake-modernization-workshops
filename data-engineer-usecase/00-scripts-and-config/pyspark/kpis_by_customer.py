...
outputGCSURI="gs://"+sourceBucketName+"/cell-tower-anomaly-detection/01-datasets/"+user_name+"/output_data/kpis_by_customer"
...
query = f"""
CREATE OR REPLACE EXTERNAL TABLE """+bqDatasetName+"""."""+user_name+"""_kpis_by_customer OPTIONS (
